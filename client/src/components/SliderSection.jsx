  ...
  return (
    <div className="w-full h-fit flex flex-col justify-center items-center px-4 lg:py-20 gap-6">
      ...
      <div className="w-full h-fit p-8">
        ...
        {
          data.map((item, index)=>(
            <div id="slider-boxes" key={index} className="p-10 bg-gradient-to-r from-purple-500 to-purple-200 rounded-xl flex flex-col justify-center items-center border-n">
